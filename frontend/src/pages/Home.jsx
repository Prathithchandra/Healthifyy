            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  <br></br>
                  Our mission is to empower patients to live vibrant, fulfilling
                  lives by prioritizing their well-being. Through a
                  patient-centric approach, we provide comprehensive healthcare
                  services that go beyond mere treatment, focusing on preventive
                  measures, holistic wellness, and disease management. Our
            ...
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  ...
                  unmatched, expert care in Health.
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center mt-[10px]">
              World-class care for everyone. Our health system offers
          ...
          <div className="flex items-center justify-between flex-col lg:flex-row ">
            <div className="xl:w-[670px]">
              ...
              <ul className="pl-4">
                ...
                <li className="text__para mt-[10px]">
                  2. Search for your physician here, and contact them.
                </li>
                <li className="text__para mt-[10px]">
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="heading">
                Most quesions by our beloved patients
              </h2>
              <FaqList/>
            </div>
          </div>
